<template>
  <div class="FilterAreaSelectPc" :class="{expand, 'FilterAreaSelectPc-2': styleType === 2}" >
    <div class="col-options" ref="colOptions">
      <div class="options-wrap" ref="optionsWrap">
        <FilterAreaOptions :dict="dict" :styleType="styleType" :isBtn="isBtn" />
      </div>
    </div>
